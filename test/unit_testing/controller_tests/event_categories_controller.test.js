...
describe('Module: event_categories_controller', function () {
    ...
    var event_categories_controller, db_interface, event_category_example, event_category_input, callback_spy;

    before(function(){
        //db_interface stub
        db_interface = require("../module_mocking/db_interface.mock.js");
        event_categories_controller = proxyquire("../../../server_files/controllers/event_categories_controller", { "../interfaces/db_interface.js": db_interface });
