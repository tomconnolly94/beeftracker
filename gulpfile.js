...
gulp.task('css', function(done) {
	...
	var client_css_page_config = JSON.parse(fs.readFileSync('build/client_css_page_config.json', 'utf8'));
...
gulp.task('js', function(done) {
	...
	var client_javascript_page_config = JSON.parse(fs.readFileSync('build/client_javascript_page_config.json', 'utf8'))
